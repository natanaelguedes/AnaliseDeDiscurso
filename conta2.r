...
getRversion() #versÃ£o do r para rodar este script Ã© a 4.2.1

getwd()
ex01 <- read.table("C:\\Users\\natan\\OneDrive\\Documentos\\19-de-mai.-11.03_-dados-da-pesquisa-2-_transiÃ§Ã£o-feita-no-word_.txt", sep = ",")
ex01$V1[611]= ""
remove.col
ex01
library(readxl)
testess <- read_excel("C:\\Users\\natan\\OneDrive\\Ãrea de Trabalho\\texto.xls")
View(testess)
?read.csv()
